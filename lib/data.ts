...
export const experience = [
  {
    id: "revelo",
    company: "Revelo (Remote Contract)",
    title: "AI Coding Trainer – TypeScript",
    period: "01/2026 – 04/2026",
    location: "Miami, Florida, United States",
    bullets: [
      "Evaluated AI-generated full-stack TypeScript and React code for quality, correctness, and maintainability.",
      "Created prompts to generate features, bug fixes, and production-ready code using Claude-based tools.",
      "Compared outputs from multiple AI models and assessed scalability, edge-case handling, and best practices.",
      "Applied structured evaluation guidelines to ensure consistent, high-quality model performance.",
    ],
  },
  {
    id: "freelance",
    ...
    location: "Remote",
    bullets: [
      "Built and deployed full-stack web applications using React.js, Node.js, Express.js, and PostgreSQL/MongoDB.",
      "Developed responsive UIs and optimized performance, reducing page load times by up to 35%.",
      "Designed and integrated REST APIs, authentication, databases, and third-party services.",
      "Delivered production-ready solutions while managing multiple client projects.",
    ],
  },
  {
    id: "netsolutions",
